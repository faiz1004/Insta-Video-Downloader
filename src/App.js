...
function App() {
  ...
  const getApidata = async () => {
    ...
    const options = {
      ...
      headers: {
        'x-rapidapi-key':'4ce8cbc9famshe201ae08f7b3b25p11de04jsn08d96a35f629',
  ...
  return (
    <div className="container mx-auto p-6 bg-gray-100 min-h-screen flex flex-col items-center">
      <a href='https://appopener.co.in/ig/8atgj29jc' target='_blank' rel='noreferrer' className='flex gap-2 items-center mb-6'>
        ...
        <span className='text-lg font-semibold text-blue-600'>Open in Instagram</span>
      </a>
